...
for path in simulations["paths"]:
    ...
    for nt in simulation["ldates"]:
        ...
        img.set_xlabel("X [px]")
        img.set_ylabel("Y [px]")
        art = img.imshow(iJ2S, origin="lower")
        plt.colorbar(art)
        ...
        img.set_xlabel("X [px]")
        img.set_ylabel("Y [px]")
        art = img.imshow(iJ2E, origin="lower")
        plt.colorbar(art)
        ...
        img.set_xlabel("X [px]")
        img.set_ylabel("Y [px]")
        art = img.imshow(iJ2D, origin="lower")
        plt.colorbar(art)
        ...
        img.set_xlabel("X [px]")
        img.set_ylabel("Y [px]")
        art = img.imshow(iP, origin="lower")
        plt.colorbar(art)
        ...
        img.set_xlabel("X [px]")
        img.set_ylabel("Y [px]")
        art = img.imshow(iW, origin="lower")
        plt.colorbar(art)
...
colors = ['#d18975', '#8fd175', '#3f2d54', '#75b8d1', '#2d543d', '#c9d175', '#d1ab75', '#d175b8', '#758bd1', '#617a89', '#0b53c1', '#ff0055', '#b3e93e', '#909495', '#ffec1b', '#fba29d', '#23d0fc']
